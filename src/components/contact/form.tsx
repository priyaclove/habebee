      ...
      <div className="container mx-auto max-w-5xl px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div className="space-y-12">
            ...
            With a rhythmic flow, the heartbeat of elegance—graceful curves of foliage embrace strength. Where purpose meets charm, the dance of nature weaves a tale of harmony and boldrefinement.            </p>
